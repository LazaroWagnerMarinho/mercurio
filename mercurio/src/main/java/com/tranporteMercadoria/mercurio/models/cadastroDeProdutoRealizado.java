...
public class cadastroDeProdutoRealizado {
	...
	public int getEntregaRealizado() {
		return entregaRealizado;
	}
	public void setEntregaRealizado(int entregaRealizado) {
		this.entregaRealizado = entregaRealizado;
	}
